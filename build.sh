...
xcrun swiftc -O -target "${kbl_arch}-apple-macosx13.0" Sources/Protocol.swift Sources/HIDTransport.swift Sources/VialTransport.swift Sources/HostNotification.swift Sources/NotificationPanel.swift Sources/App.swift Sources/main.swift -framework AppKit -framework SwiftUI -framework IOKit -o "$kbl_app/Contents/MacOS/KeyboardLight"
